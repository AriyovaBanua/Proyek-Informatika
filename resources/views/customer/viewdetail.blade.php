        ...
        <div class="row px-xl-5">
            <div class="col-lg-5 pb-5">
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        ...
                        <img class="img-fluid w-100" src="{{ asset('assets/img/sapi.jpg') }}" alt="Product Image">
                        </div>
                        <div class="carousel-item">
                        <img class="img-fluid w-100" src="{{ asset('assets/img/dolpin.jpg') }}" alt="Product Image">
                        </div>
                        <div class="carousel-item">
            ...
            <div class="col-lg-7 pb-5">
                ...
                <div class="d-flex align-items-center mb-4 pt-2">
                    ...
                    <button class="btn btn-primary px-3" onclick="redirectToChart()"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button>

<script>
    function redirectToChart() {
        // Ganti URL sesuai kebutuhan Anda
        window.location.href = "{{ url('arca_artshop/shop/view_detail/chart') }}";
    }
</script>
                ...
                <div class="owl-carousel related-carousel">
                    <div class="card product-item border-0">
                        ...
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="{{url("arca_artshop/shop/view_detail")}}" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
...
<script>
  $(document).ready(function() {
    $(".btn-plus").click(function() {
      ...
      var quantity = parseInt($(".form-control").val());
      $(".form-control").val(quantity + 1);
    });

    $(".btn-minus").click(function() {
      // Decrement the quantity value, but not below 1
      var quantity = parseInt($(".form-control").val());
      if (quantity > 1) {
        $(".form-control").val(quantity - 1);
      }
