        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-between" id="navcol-1">
                <ul class="navbar-nav" style="color: var(--bs-white); font-weight: bold;">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#" style="color: var(--bs-white);">Shop</a></li>
                    <li class="nav-item"><a class="nav-link" href="#" style="color: var(--bs-white);">My Orders</a></li>
                    <li class="nav-item"><a class="nav-link" href="#" style="color: var(--bs-white);">Contact</a></li>
                </ul>
                <div class="d-flex">
