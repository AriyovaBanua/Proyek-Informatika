            ...
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody class="align-middle">
                        <tr>
                            <td class="align-middle"><img src="{{ asset('assets/img/sapi.jpg') }}" alt="" style="width: 50px;"> Colorful Stylish Shirt</td>
            ...
            <div class="col-lg-4">
                <form class="mb-5" action="">
                    <div class="input-group">
                        <input type="text" class="form-control p-4" placeholder="Order Summary">
                        <div class="input-group-append">
                            <button class="btn btn-primary">Order Summary</button>
                        </div>
                    </div>
                </form>
